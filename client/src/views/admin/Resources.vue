<template>
  <div class="resources-list-page">
    ...
    <div class="filter-bar">
      ...
      <el-input v-model="searchKey" placeholder="搜索资源名称" style="width:200px" clearable @keyup.enter="loadData" />
      <el-button type="primary" @click="loadData">搜索</el-button>
    </div>
    <el-table :data="resources" stripe border v-loading="loading">
      <el-table-column prop="title" label="资源名称" min-width="180" show-overflow-tooltip />
      <el-table-column prop="company_name" label="商家" width="140" />
    ...
    <!-- 详情对话框 -->
    <el-dialog v-model="showDetail" title="资源详情" width="720px">
      <div v-if="currentRow">
...
<style scoped>
.resources-list-page h2 { margin-bottom: 20px; font-size: 18px; font-weight: 600; }
