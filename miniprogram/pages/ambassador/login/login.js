...
Page({
    ...
    app.wechatLogin()
      ...
      .then(res => {
        ...
        if (res.data.code === 200 || res.data.code === 0) {
          ...
          wx.setStorageSync('userType', 'ambassador')
  ...
  sendCode() {
    ...
    app.wechatLogin()
      .then(() => {
        return wx.request({
          url: `${app.globalData.apiBase}/ambassador/sendCode`,
          method: 'POST',
          data: {
            phone,
            openid: app.globalData.openid,
  ...
  goBack() {
    // 登录成功后跳转到大使首页
    wx.reLaunch({ url: '/pages/ambassador/home/home' })
  },
  ...
  mockLogin(userType) {
    ...
    const testPhone = '18800000003'  // 大使测试账号
