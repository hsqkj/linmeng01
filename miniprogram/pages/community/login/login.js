...
Page({
    ...
    app.wechatLogin()
      ...
      .then(res => {
        ...
        if (res.data.code === 200 || res.data.code === 0) {
          ...
          wx.setStorageSync('userType', 'community')
  ...
  sendCode() {
    ...
    app.wechatLogin()
      .then(() => {
        return wx.request({
          url: `${app.globalData.apiBase}/community/sendCode`,
          method: 'POST',
          data: {
            phone,
            openid: app.globalData.openid,
  ...
  mockLogin(userType) {
    ...
    const testPhone = '18800000001'  // 社区测试账号
