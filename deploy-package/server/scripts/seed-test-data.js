...
async function addTestData() {
  ...
  try {
    ...
    await connection.query(`
      ...
      VALUES
        ('13800138000', ?, '张慧芳', '13800138000', '江岸区', '后湖街道', '百步亭社区', '百步亭花园居委会', '社区书记',
         3200, 62, 18, 800, 1, 1, 1, 0, 45, '江岸区大型成熟社区，居民以机关事业单位职工为主，文化活动丰富，消费理性务实。', 1),
        ('13800138001', ?, '李明远', '13800138001', '武昌区', '中南路街道', '中南路社区', '中南路居委会', '社区副书记',
         2800, 55, 22, 600, 1, 1, 0, 1, 38, '武昌区核心商圈，社区周边商务楼宇密集，年轻人居多，商业配套成熟。', 1),
        ('13800138002', ?, '王秀英', '13800138002', '洪山区', '珞南街道', '珞桂社区', '珞桂花园居委会', '社区工作者',
         4500, 68, 15, 1200, 1, 1, 1, 1, 62, '洪山区大型居住社区，年轻家庭为主，高校和科研院所环绕，儿童教育和文体需求旺盛。', 1)
